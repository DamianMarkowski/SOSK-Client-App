...
public class StudentCoursesNotStartedListCustomAdapter extends BaseAdapter{
    List<CourseHelper> result = new ArrayList<CourseHelper>();
    Context context;
    Intent intentStudentCourse;
    private static LayoutInflater inflater=null;
    public StudentCoursesNotStartedListCustomAdapter(StudentMainScreen mainActivity, List<CourseHelper> coursesList) {
