...
public class TeacherPracticalLessons extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_teacher_practical_lessons);
        ...
        new InstructorStudentsListRequest().execute();
    ...
    public class InstructorStudentsListRequest extends AsyncTask<Void, Void, StudentsList> {
        @Override
        protected StudentsList doInBackground(Void... params) {
            try {
                final String url = GlobalVars.hostUrl + "teacher/instructor/listOfStudents?courseId=" + GlobalVars.courseId;
        ...
        protected void onPostExecute(StudentsList list) {
            ...
            listView.setAdapter(new TeacherPracticalLessonsListCustomAdapter(TeacherPracticalLessons.this, students));
        }
    }
}
