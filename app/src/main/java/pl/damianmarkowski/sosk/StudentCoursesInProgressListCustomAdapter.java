...
public class StudentCoursesInProgressListCustomAdapter extends BaseAdapter{
    List<CourseHelper> result = new ArrayList<CourseHelper>();
    Context context;
    Intent intentStudentCourse;
    private static LayoutInflater inflater=null;
    public StudentCoursesInProgressListCustomAdapter(StudentMainScreen mainActivity, List<CourseHelper> coursesList) {
